...
contract OKEY is Ownable {
   ...
   public {
       bool okeyOwner = (msg.sender == ownerOf(tokenId)) || (msg.sender == AUTHORIZER);
       require(okeyOwner, "not Okey Owner");
   ...
   public view returns (address) {
       require(exist(id), "okey not exist");
       return owners[id];
   }
   ...
   private {
       ...
       require(owners[id] == address(0), "not okey owner");
   ...
   private {
       require(exist(id), "okey not exist");
       require(from == ownerOf(id), "not okey owner");
